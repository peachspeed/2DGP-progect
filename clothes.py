...
def reset_world():
    ...
    items = [
        ...
        DragItem(900, 600, 'top4.png', 'top'),
        DragItem(900, 600, 'top5.png', 'top'),
        DragItem(900, 600, 'top6.png', 'top'),
        DragItem(900, 600, 'top7.png', 'top'),
        DragItem(900, 600, 'top8.png', 'top'),
        DragItem(700, 500, 'bottom1.png', 'bottom'),
        DragItem(800, 500, 'bottom2.png', 'bottom'),
        DragItem(900, 500, 'bottom3.png', 'bottom'),
        DragItem(700, 500, 'bottom4.png', 'bottom'),
        DragItem(800, 500, 'bottom5.png', 'bottom'),
        DragItem(900, 500, 'bottom6.png', 'bottom'),
        DragItem(900, 500, 'bottom7.png', 'bottom'),
        ...
        DragItem(700, 400, 'hair8.png', 'hair'),
        DragItem(800, 400, 'hair9.png', 'hair'),
        DragItem(900, 400, 'hair10.png', 'hair'),
        DragItem(700, 300, 'hair11.png', 'hair'),
        DragItem(800, 300, 'hair12.png', 'hair'),
        DragItem(900, 300, 'hair13.png', 'hair'),
        DragItem(700, 200, 'hair14.png', 'hair'),
        DragItem(800, 300, 'hair15.png', 'hair'),
        DragItem(900, 300, 'hair16.png', 'hair'),
        DragItem(700, 200, 'hair17.png', 'hair'),
    ]
